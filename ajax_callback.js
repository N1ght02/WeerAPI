...
let weatherObject = JSON.parse(weatherString); // Convert JSON string => Object.
let reclame = ["Drink bier Maak geen oorlog", "Grolosch Is het beste!", "<img src='Bier.png'>  ", "Laatste reclame bericht!"];
	let ditWeer =
		weatherObject.liveweer[0].plaats+ " -" +

		"<span class=tickWrapper>" +
		"<span class='paars'>T</span>emperatuur | " +
		weatherObject.liveweer[0].temp + " &#176;C" +
		"</span>" +

		//Reclame
		"<span class=tickWrapper>" +
		"<span class='paars'>R</span>eclame | " +
		reclame[0] +
		"</span>" +


		"<span class=tickWrapper>" +
		" <span class='paars'>G</span>emiddelde tempratuur | "+
		weatherObject.liveweer[0].gtemp+
		"</span>" +
		...
		"<span class=tickWrapper>" +
		" <span class='paars'>B</span>ewolking | "+
		weatherObject.liveweer[0].samenv+
		"</span>" +
		...
		"<span class=tickWrapper>" +
		" <span class='paars'>W</span>indkracht | "+
		weatherObject.liveweer[0].windk+
		"</span>" +
